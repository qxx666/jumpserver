...
router.register(r'escape', api.EscapeRoutePlanViewSet, 'escape')
router.register(r'escape-execution', api.EscapeRoutePlanExecutionViewSet, 'escape-execution')
router.register(r'escape-execution-subtask', api.EscapeRoutePlanExecutionSubtaskViewSet, 'escape-execution-subtask')
