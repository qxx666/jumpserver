# Generated by Django 3.1.13 on 2022-01-04 06:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Escape route plan',
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='execution', to='assets.escaperouteplan', verbose_name='Escape route plan')),
            ],
            options={
                'verbose_name': 'Escape route execution',
            },
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_start', models.DateTimeField(auto_now_add=True, verbose_name='Date start')),
                ('timedelta', models.FloatField(default=0.0, null=True, verbose_name='Time')),
                ('execution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task', to='assets.escaperouteplanexecution', verbose_name='Escape route plan execution')),
            ],
            options={
                'verbose_name': 'Escape route plan task',
            },
        ),
    ]
